...
import { TOPTAL_JS_API, HTTP_REQUEST_CONFIG, API_TIMEOUT_MS, MAX_FILE_SIZE_BYTES, calculateStats } from '@/lib';
...
export async function minifyJavaScript(text: string): Promise<MinificationResult | null> {
	...
	if (fileSizeBytes > MAX_FILE_SIZE_BYTES) {
		...
		vscode.window.showErrorMessage(t('minificationService.fileSize.tooLarge', sizeMB));
		return null;
	}
